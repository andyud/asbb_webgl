...
public class Reporter : MonoBehaviour {
	...
	void Awake()
	{
        //if( !GameConfig.instance.useReporter )
        //{
	...
	void DrawInfo()
	{
        ...
        GUILayout.Box(showSceneContent, nonStyle, GUILayout.Width(size.x), GUILayout.Height(size.y));
        GUILayout.Space(size.x);
        GUILayout.Label("graphicsDeviceVersion = " + SystemInfo.graphicsDeviceVersion, nonStyle, GUILayout.Height(size.y));
        GUILayout.FlexibleSpace();
        GUILayout.EndHorizontal();
        ...
        GUILayout.Box(showSceneContent, nonStyle, GUILayout.Width(size.x), GUILayout.Height(size.y));
        GUILayout.Space(size.x);
        GUILayout.Label("graphicsDeviceVendorID = " + SystemInfo.graphicsDeviceVendorID.ToString(), nonStyle, GUILayout.Height(size.y));
        GUILayout.FlexibleSpace();
        GUILayout.EndHorizontal();
        ...
        GUILayout.Box(showSceneContent, nonStyle, GUILayout.Width(size.x), GUILayout.Height(size.y));
        GUILayout.Space(size.x);
        GUILayout.Label("graphicsDeviceName = " + SystemInfo.graphicsDeviceName, nonStyle, GUILayout.Height(size.y));
        GUILayout.FlexibleSpace();
        GUILayout.EndHorizontal();
        ...
        GUILayout.Box(showSceneContent, nonStyle, GUILayout.Width(size.x), GUILayout.Height(size.y));
        GUILayout.Space(size.x);
        GUILayout.Label("graphicsDeviceID = " + SystemInfo.graphicsDeviceID.ToString(), nonStyle, GUILayout.Height(size.y));
        GUILayout.FlexibleSpace();
        GUILayout.EndHorizontal();
        ...
        GUILayout.Box(showSceneContent, nonStyle, GUILayout.Width(size.x), GUILayout.Height(size.y));
        GUILayout.Space(size.x);
        GUILayout.Label("graphicsShaderLevel = " + SystemInfo.graphicsShaderLevel.ToString(), nonStyle, GUILayout.Height(size.y));
        GUILayout.FlexibleSpace();
        GUILayout.EndHorizontal();
	...
	void Update()
	{
        ...
        //addSample();
#if !UNITY_5 && !UNITY_STANDALONE_WIN && !UNITY_2017_1 && !UNITY_2017_2
        if( string.IsNullOrEmpty( scenes[ Application.loadedLevel ] ))
			scenes[ Application.loadedLevel ] = Application.loadedLevelName ;
#else
        if ( !UnityEngine.SceneManagement.SceneManager.GetActiveScene().buildIndex.Equals( -1 ) &&
            string.IsNullOrEmpty( scenes[ UnityEngine.SceneManagement.SceneManager.GetActiveScene().buildIndex ] ) )
